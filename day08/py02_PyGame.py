...
def main():
    ...
    while True:
        ...
        # 선
        pygame.draw.line(Surface, color='red', start_pos=(30,30), end_pos=(150,30),width=3) # width 뭔지 보기
        line(Surface, (0,255,0), (30,70), (150,70),5)
        ...
        Surface.blit(snake, (0,336), (0,0,64,32)) # 이미지 자르기 
